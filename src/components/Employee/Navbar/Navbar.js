...
const Navbar = ({ children }) => {
  ...
  return (
    <div data-theme={theme ? "dark" : "light"} className="drawer ">
      <input id="my-drawer-3" type="checkbox" className="drawer-toggle" />
      <div className="drawer-content flex flex-col">
        <div className="w-full navbar z-50 sticky top-0 bg-base-300">
          ...
          <div className="flex-1 px-2 mx-2 uppercase">
            <img
              className="w-10"
              src="https://i.ibb.co/VqWJVLj/logo.png"
              alt=""
            />
            Employee{" "}
          </div>
              ...
              <div className="dropdown dropdown-end pt-2">
                <label tabIndex={0} className="btn btn-ghost btn-circle avatar">
                  <div className="w-10 rounded-full">
                    <img src="https://i.ibb.co/ysxgB8B/images.png" alt="user" />
                  </div>
                </label>
                <ul
                  tabIndex={0}
